...
<ImCross onClick={closeModal}    size={22}  className='hover:text-blue-400 text-current '  color='text-white'  />
        ...
        <h1 className='text-lg font-semibold tracking-tighter text-left mt-2'> Client</h1>
         ...
         {Data.user.sex ===2 ?  <img src='https://us.123rf.com/450wm/apoev/apoev1903/apoev190300160/124274049-person-white-photo-placeholder-woman-silhouette-on-gray-background.jpg?ver=6' 
 ...
 <h1 className='text-lg capitalize '>sexe : <span className='font-bold'>{ Data.user.sex ===1 ? "Masculin" : "Feminin"  }</span></h1>
 <h1 className='text-lg capitalize '>Numero de telephone : <span className='font-bold'>{Data.user.phoneNumber}</span></h1>
