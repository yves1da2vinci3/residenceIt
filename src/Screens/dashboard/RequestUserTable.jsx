      ...
      <div className="overflow-x-auto">
        <div className="inline-block w-full overflow-hidden">
          <table className="w-full ">
            <thead>
              <tr className="bg-gray-50">
                <td className="relative p-0">
                  <div className="flex items-center pl-11 h-20  border-b border-gray-100">
                ...
                <td className="p-0">
                  <div className="flex items-center h-20 border-b border-gray-100" />
                </td>
                <td className="p-0">
            ...
            <tbody>
       <UserItem  requestState={0} />
       <UserItem  requestState={1} />
       <UserItem  requestState={1} />
       <UserItem  requestState={0} />
       <UserItem  requestState={0} />
       <UserItem  requestState={0} />
